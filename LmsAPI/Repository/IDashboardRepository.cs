...
namespace LMSAPI.Repository
{
    public interface IDashboardRepository
    {
        ...
        Task<List<readhistorydto>> ReadHistory(int Id);
        ...
        Task<CreateOrder> UpdateRazorpayOrderStatus(string orderId, string paymentId, string signature, int userId, string status);
    }
}
